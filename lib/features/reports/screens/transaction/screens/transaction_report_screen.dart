          ...
          menuWidget: PopupMenuButton(
            ...
            onSelected: (dynamic value) {
              if (value == FilterType.all) {
                reportController.setFilter(FilterType.all.name, transaction: true);
              }else if (value == FilterType.thisYear) {
                reportController.setFilter(FilterType.thisYear.name, transaction: true);
              }else if (value == FilterType.previousYear) {
                reportController.setFilter(FilterType.previousYear.name, transaction: true);
              }else if (value == FilterType.thisMonth) {
                reportController.setFilter(FilterType.thisMonth.name, transaction: true);
              }else if (value == FilterType.thisWeek) {
                reportController.setFilter(FilterType.thisWeek.name, transaction: true);
              } else{
