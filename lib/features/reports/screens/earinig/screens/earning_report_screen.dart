...
import 'package:stackfood_multivendor_restaurant/features/reports/screens/earinig/widgets/earning_card_widget.dart';
import 'package:stackfood_multivendor_restaurant/features/reports/screens/earinig/widgets/earning_sources_bottom_sheet.dart';
import 'package:stackfood_multivendor_restaurant/features/reports/screens/earinig/widgets/earning_trend_chart.dart';
import 'package:stackfood_multivendor_restaurant/features/reports/screens/earinig/widgets/transaction_menu_button_widget.dart';
...
class _EarningReportScreenState extends State<EarningReportScreen> {
  ...
  void initState() {
    ...
    Get.find<ReportController>().setFilter(FilterType.thisMonth.name, isEarningReport : true);
        ...
        appBar: CustomAppBarWidget(
          ...
          menuWidget: PopupMenuButton(
            ...
            itemBuilder: (context) { return <PopupMenuEntry>[
              PopupMenuItem(
                value: FilterType.all, child: SizedBox(width: 100, child: Text('all_the_time'.tr, style: robotoRegular)),
              ),
              PopupMenuItem(
          ...
          child: Column(children: [
            ...
            Column(
              ...
              children: [
                ...
                ) :  TrendChart(data: _buildTrendData(reportController)),
                const SizedBox(height: Dimensions.paddingSizeDefault,),
                      ...
                      child: Row(
                        ...
                        children: [
                          TransactionsMenuButton(
                            label: 'earnings'.tr, count: reportController.getEarningReportModel?.summary?.totalTransactionEarning ?? 0, isSelected: value == 0, onTap: () {
                          ...
                          TransactionsMenuButton(
                            label: 'expenses'.tr, count: reportController.getEarningReportModel?.summary?.totalTransactionExpense ?? 0, isSelected: value == 1, onTap: () {
                          ...
                          TransactionsMenuButton(
                            label: 'subscription'.tr, count: reportController.getEarningReportModel?.summary?.totalTransactionSubscription ?? 0, isSelected: value == 2, onTap: () {
                            ...
                            child: Column(children: [
                              ...
                              Container(
                                ...
                                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Text(PriceConverter.priceFormate(data.amount, currencySymbolDirectionRight: false), style: robotoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault), textAlign: TextAlign.end),
