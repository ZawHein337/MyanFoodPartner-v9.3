...
class ImageAnalyzeBottomSheet extends StatefulWidget {
  ...
  const ImageAnalyzeBottomSheet({super.key, this.nameControllerList, this.descriptionControllerList, this.priceController, this.discountController, this.maxOrderQuantityController, this.languageList, this.tabController});
