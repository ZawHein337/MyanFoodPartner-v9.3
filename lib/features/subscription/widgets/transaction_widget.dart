      ...
      return Column(children: [
        ...
        Padding(
          padding: const EdgeInsets.only(
            top: Dimensions.paddingSizeLarge, left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault,
          ),
          child: Row(children: [
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(subscriptionController.searchMode ? Icons.clear : null, color: Theme.of(context).hintColor),
                    onPressed: (){
                          ...
                          child: Row(children: [
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Text(DateConverter.utcToDateTime(transactions.createdAt!), style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                              ]),
                            ),
                            const SizedBox(width: Dimensions.paddingSizeSmall),
                        ...
                        Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text('subscription_plan'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                              Text(transactions.package?.packageName ?? '', style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                            ]),

                            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                              Text('validity'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                              Text('${transactions.validity} ${'days'.tr}', style: robotoBold),
                            ]),
                          ]),
                        ),
