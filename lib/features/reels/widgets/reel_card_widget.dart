...
class ReelCardWidget extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        ...
        _statItem(
          ...
          label: 'visits'.tr,
          value: _formatCount(reel.totalRestaurantVisits ?? 0),
        ),
      ],
    );
  }
  ...
  List<Map<String, dynamic>> _getMenuItems() {
    const Color brandColor = Color(0xFF107980);
    switch (reel.reelStatusLabel) {
      case 'live':
        return [
          {'value': 'view', 'label': 'view_reel', 'icon': const Icon(Icons.remove_red_eye_outlined, color: brandColor, size: 18)},
          {'value': 'deactivate', 'label': 'deactivate_reel', 'icon': const CustomToggleButtonWidget(isActive: true)},
          {'value': 'edit', 'label': 'edit_reel', 'icon': const Icon(Icons.edit, color: Colors.blue, size: 20)},
          {'value': 'delete', 'label': 'delete_reel', 'icon': const Icon(Icons.delete_outline, color: Colors.red, size: 20)},
        ];
      case 'upcoming':
        return [
          {'value': 'view', 'label': 'view_reel', 'icon': const Icon(Icons.remove_red_eye_outlined, color: brandColor, size: 18)},
          {'value': 'edit', 'label': 'edit_reel', 'icon': const Icon(Icons.edit, color: Colors.blue, size: 18)},
          {'value': 'delete', 'label': 'delete_reel', 'icon': const Icon(Icons.delete_outline, color: Colors.red, size: 20)},
        ];
      case 'expired':
        return [
      ...
      case 'deactivated':
        return [
          {'value': 'view', 'label': 'view_reel', 'icon': const Icon(Icons.remove_red_eye_outlined, color: brandColor, size: 18)},
          {'value': 'edit', 'label': 'edit_reel', 'icon': const Icon(Icons.edit, color: Colors.blue, size: 18)},
          {'value': 'activate', 'label': 'activate_reel', 'icon': const CustomToggleButtonWidget(isActive: false)},
          {'value': 'delete', 'label': 'delete_reel', 'icon': const Icon(Icons.delete_outline, color: Colors.red, size: 20)},
        ];
      default:
        return [
