...
import 'package:stackfood_multivendor_restaurant/features/reels/widgets/reel_card_widget.dart';
...
class _ReelsScreenState extends State<ReelsScreen> {
  ...
  Widget _statusTabWidget({
    ...
    final GlobalKey tabKey = _tabKeys.putIfAbsent(index, () => GlobalKey());
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: Dimensions.paddingSizeDefault),
          Text(
            reelsController.isSearchActive ? 'no_reels_found'.tr : 'no_reels_available'.tr,
            style: robotoMedium.copyWith(
          ...
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Text(
            reelsController.isSearchActive ? 'try_different_search'.tr : 'create_your_first_reel'.tr,
