...
import 'package:stackfood_multivendor_restaurant/features/reels/widgets/reel_video_preview_widget.dart';
...
class ReelDetailsScreen extends StatelessWidget {
  ...
  String _formatDate(String? raw) {
    ...
    try {
      return DateConverter.convertDateToDate(raw);
    } catch (_) {
      return raw;
    }
  }
          ...
          children: [
            Expanded(
              child: _statCard(
                ...
                label: 'total_sale'.tr,
                value: _formatCount(reel.orderCount ?? 0),
              ),
            ),
            const SizedBox(width: Dimensions.paddingSizeSmall),
            Expanded(
              child: _statCard(
                ...
                label: 'total_sale_amount'.tr,
                value: PriceConverter.convertPrice(reel.totalSaleAmount ?? 0),
              ),
            ),
          ],
        ),
